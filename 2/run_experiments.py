...
def run_experiment(network_delay, interarrival_time, flood_percentage):
    # run seed
    ...
    while 1:
        if (time.time() - start_time) > TIMEOUT:
            ...
            os.killpg(os.getpgid(proc_victim.pid), signal.SIGINT)
            os.killpg(os.getpgid(proc_normal.pid), signal.SIGINT)
...
if __name__ == "__main__":
    run_experiment(network_delay=args.nd, interarrival_time=args.iat, flood_percentage=args.flood_percentage)